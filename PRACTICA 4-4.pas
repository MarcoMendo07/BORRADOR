...
begin
	if(a = nil)then entreDosValores:= 0
		...
		if(a^.dato.cod >= codigo1)and(a^.dato.cod <= codigo2)then
			entreDosValores:=
...
{writeln;
writeln('Codigo maximo del arbol 1: ',maximo(a1));
writeln;
writeln('Codigo minimo del arbol 2: ',minimo(a2));

writeln;
writeln('Ingrese un numero de cliente para ver sus alquileres realizados: ');
readln(cliente);
writeln;
writeln('Cant de alquileres del cliente num ',cliente,' : ',cantAlquileres(a1,cliente));
...
writeln('Cant de alquileres del cliente num ',cliente,' : ',cant);}
